...
public class PublishingTests
{
    ...
    public void BuildPublishMatrix_ResolvesConvenienceTags()
    {
        ...
        Assert.Contains("ghcr.io/agentcontainers/ac-dotnet:claude-0.1.0", dotnetClaude.ImageTags);
        Assert.Contains("ghcr.io/agentcontainers/ac-dotnet:claude-latest", dotnetClaude.ImageTags);
        Assert.Contains("ghcr.io/agentcontainers/ac-claude:dotnet10-node24", dotnetClaude.ImageTags);
    }
}
